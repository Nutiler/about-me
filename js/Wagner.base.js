...
WAGNER.DirtPass = function() {
	...
	WAGNER.Pass.call( this );
	this.blendPass = new WAGNER.BlendPass();
	this.dirtTexture = tloader.load( WAGNER.assetsPath + '/textures/dirt8.jpg' );
...
WAGNER.ASCIIPass = function() {
	...
	this.loadShader( 'ascii-fs.glsl', function() {
		this.shader.uniforms.tAscii.value = tloader.load( WAGNER.assetsPath + '/ascii/8x16_ascii_font_sorted.gif' );
	} );
